...
public class Model {
    ...
    private Model() {
        ...
        usuarios.put("001", new Usuario("joan.corea08@gmail.com", "Joan", "Corea", "123", 0, 84289652));
        usuarios.put("002", new Usuario("roy.arias@gmail.com", "Roy", "Arias", "123", 0, 88774589));
        usuarios.put("003", new Usuario("jorge.canales@gmail.com", "Jorge", "Canales", "123", 0, 88541236));
