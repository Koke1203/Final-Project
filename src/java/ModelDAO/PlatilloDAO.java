    ...
    public List listarPlatillos() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                per.setCategoria_descripcion(rs.getString("categoria_descripcion"));
                per.setFk_codigo_adicional(rs.getInt("fk_codigo_adicional"));
                list.add(per);
            }
        } catch (Exception e) {
        }
    ...
    public Platillo listForCodigo(int codigo_plato) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                p.setCategoria_descripcion(rs.getString("categoria_descripcion"));
                p.setFk_codigo_adicional(rs.getInt("fk_codigo_adicional"));
            }
        } catch (Exception e) {
        }
        return p;
