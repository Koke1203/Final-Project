...
<head>
    ...
    <title>Dashboard - Administrator Panel - Demo Tasty</title>
    <link rel="stylesheet" type="text/css" href="css_admin/flame.css" name="flame-css">
    <link rel="stylesheet" type="text/css" href="css_admin/admin.css" name="admin-css">
</head>
...
<body class="page ">
                        ...
                        <div class="dropdown-menu">
                            <div class="d-flex flex-column w-100 align-items-center">
                                ...
                                <div class="pb-3 text-center">
                                    <div class="text-uppercase">USUARIO LOGUEADO</div>
            ...
            <ul id="side-nav-menu" class="nav">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse" aria-expanded="false">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mealtimes" href="DIRECCIONES NUESTRAS"
                                aria-expanded="false">
    ...
    <script charset="utf-8" type="text/javascript" src="js/flame.js"
        name="flame-js"></script>

    <script charset="utf-8" type="text/javascript" src="js/admin.js"
